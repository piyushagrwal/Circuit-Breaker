package com.utilities.urlutf8encoder;

public class URLUTF8Encoder {

    static final String[] hex = {"%00","%01","%02","%03","%04","%05","%06","%07", "%08","%09","%0A","%0B","%0C","%0D","%0E","%0F",
    ...
    public static String encode(String s){
        ...
        for(int i=0; i<len; i++){
            ...
            if(isSafe(ch)){
                ...
                sbf.append(hex[(0xC0 | ch >> 6)]);
                sbf.append(hex[(0x80 | ch & 0x3F)]);
            } else{
                sbf.append(hex[(0xE0 | ch >> 12)]);
                sbf.append(hex[(0x80 | ch >> 6 & 0x3F)]);
                sbf.append(hex[(0x80 | ch & 0x3F)]);
            }
        }
        return sbf.toString();
    ...
    private static boolean isSafe(int ch){
        return (((65 <= ch) && (ch <= 90)) || ((97 <= ch) && (ch <= 122)) || ((48 <= ch) && (ch <= 57))
                || (ch == 45) || (ch == 95) || (ch == 46) || (ch == 33) || (ch == 126) || (ch == 42)
                || (ch == 39) || (ch == 40) || (ch == 41) || (ch == 32));
    }
}
